...
class ProfileDetailsMobile extends StatefulWidget {
  const ProfileDetailsMobile({Key? key, required this.student}) : super(key: key);

  final Student student;

  @override
  State<ProfileDetailsMobile> createState() => _ProfileDetailsMobileState();
}

class _ProfileDetailsMobileState extends State<ProfileDetailsMobile> {
