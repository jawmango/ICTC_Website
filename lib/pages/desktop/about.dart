            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  _buildMissionMobile(context),
                  _ourTeamMobile(context),
...
Widget _buildHeroMobile(context) {
  return Stack(
    children: [
      Container(
        color: Colors.grey[50],
...
Widget _buildMissionMobile(context) {
  return Stack(
    children: [
      Container(
        color: Color(0xff19306B),
        ...
        child: Center( // Adjust right padding for logo position
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
...
Widget _ourTeamMobile(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(20.0),
      child: SingleChildScrollView(
        scrollDirection: Axis.horizontal,
        ...
        child: Column(
          children: [
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [ // Adding space at the beginning
                _buildTeamMemberCardMobile(
                  'Michelle Elija B. Santos',
                  'DIRECTOR',
                  'assets/images/director.png', // Replace with actual image path
                  imageSize: 200.0, // Adjust image size as needed
                  cardWidth: 310.0,
                  cardHeigth: 400.0,  // Adjust card width as needed
                ),
                SizedBox(width: 5.0), // Adding space between cards
  ...
  Widget _buildTeamMemberCardMobile(
    String name,
    String position,
    String imagePath, {
